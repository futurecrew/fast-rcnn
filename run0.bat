...
if "%step_3%" equ "true" (
  ...
  echo "-------------------------------------------------"
  tools\train_net.py --gpu 0 --solver models/VGG_CNN_M_1024/rpn/solver_step3.prototxt --weights output/fast_rcnn/voc_2007_trainval_with_rpn/vgg_cnn_m_1024_fast_rcnn_with_rpn_iter_%iters_frcnn%.caffemodel --model_to_use rpn --cfg experiments/cfgs/faster_rcnn.yml --iters %iters_rpn% 2>&1
...
if "%step_4%" equ "true" (
  ...
  echo "-------------------------------------------------"
  tools\train_net.py --gpu 0 --solver models/VGG_CNN_M_1024/solver_step4.prototxt --weights output/fast_rcnn/voc_2007_trainval_with_rpn/vgg_cnn_m_1024_fast_rcnn_with_rpn_iter_%iters_frcnn%.caffemodel --model_to_use frcnn --cfg experiments/cfgs/fast_rcnn.yml --proposal rpn --proposal_file=data/rpn_data/voc_2007_trainval_step_3_rpn_top_2300_candidate.pkl --iters %iters_frcnn% 2>&1
)
